...
//aucune restriction
    //Entreprise
if (($_SESSION['erreurIext'] == true) || ($_SESSION['erreurItaille'] == true)) //FONCTIONNE PAS JAMAIS EGALE A TRUE
{ $_SESSION['erreurImage']=true ;}
else {$_SESSION['erreurImage']=false ;}

if (($_SESSION['erreurFext'] == true) || ($_SESSION['erreurFtaille'] == true)) //FONCTIONNE PAS JAMAIS EGALE A TRUE
...
if (($_SESSION['erreurdateDO']==false)&&($_SESSION['erreurImage'] ==false) && ($_SESSION['erreurFichier']==false)) { 
    //
    //Adresse
    //
    ...
    $requete  = $BDD -> prepare ("UPDATE OFFRE
                                  SET offre_nom= :nomO, offre_profil= :profilO, offre_dateDeb= :dateDO, offre_duree= :dureeO, offre_descrCourte= :descripCO, offre_descrLongue= :descripLO, offre_fichier= :fichierO, offre_valide = 0, offre_signalee = 0, offre_renum= :remunO, contact_id= $contact_id, entreprise_id= $entreprise_id, adresse_id= :adresse_idU
                                  WHERE offre_id=".$_SESSION['numO']);
    ...
    $_SESSION['OffreModifiee']=true; // L'offre a été modifié
